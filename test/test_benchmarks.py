...
class BenchmarksTestCase(unittest.TestCase):
    ...
    def test_get_result_complete(self):
        ...
        self.assertEquals(1, benchmark[0]['benchmark-id'])
        self.assertEquals({"00000": 1024}, benchmark[0]['counts'])
        self.assertEquals(1, benchmark[0]['original-depth'])
        self.assertEquals(1, benchmark[0]['original-width'])
        self.assertEquals(10, benchmark[0]['transpiled-depth'])
        self.assertEquals(1, benchmark[0]['transpiled-width'])
        self.assertEquals(1024, benchmark[0]['shots'])
        self.assertEqual(True, benchmark[0]['complete'])

        self.assertEquals(1, benchmark[1]['benchmark-id'])
        self.assertEquals({"10000": 1024}, benchmark[1]['counts'])
        self.assertEquals(1, benchmark[1]['original-depth'])
        self.assertEquals(1, benchmark[1]['original-width'])
        self.assertEquals(10, benchmark[1]['transpiled-depth'])
        self.assertEquals(1, benchmark[1]['transpiled-width'])
